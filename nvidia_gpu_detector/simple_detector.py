...
from yolo_detector_tensorrt import YOLOv11DetectorTensorRT
...
class SimpleRealtimeDetector:
    ...
    def __init__(self,
        ...
        """
        print("="*80)
        print(f"VALORANT 实时检测系统 - TensorRT 版本 (捕获中心 {center_size}x{center_size})")
        print("="*80)

        self.center_size = center_size

        # 加载检测模型
        print("\n[1/2] 加载 TensorRT 检测模型...")
        self.detector = YOLOv11DetectorTensorRT(
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                # 显示
                cv2.imshow("VALORANT Detection - TensorRT", vis_frame)
